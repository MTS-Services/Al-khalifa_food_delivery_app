...
import 'package:al_khalifa/app/modules/signup_otp/views/signup_otp_view.dart';
...
class SignupController extends GetxController {
  ...
  Future<void> getSignUP()async{
    ...
    update();
    try{
      final response=await AuthApiServices.signUpRequest(Urls.registration, <String,dynamic>{
